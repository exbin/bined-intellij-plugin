...
dependencies {
    ...
    implementation(exbinFrameworkLibrary("exbin-framework-addon"))
    ...
    implementation(exbinFrameworkLibrary("exbin-framework-context"))
    implementation(exbinFrameworkLibrary("exbin-framework-context-api"))
...
//    implementation(exbinFrameworkLibrary("exbin-framework-data"))
    ...
    implementation(exbinFrameworkLibrary("exbin-framework-document"))
    implementation(exbinFrameworkLibrary("exbin-framework-document-api"))
    implementation(exbinFrameworkLibrary("exbin-framework-docking"))
    implementation(exbinFrameworkLibrary("exbin-framework-docking-api"))
    implementation(exbinFrameworkLibrary("exbin-framework-docking-multi"))
    implementation(exbinFrameworkLibrary("exbin-framework-docking-multi-api"))
    ...
    implementation(exbinFrameworkLibrary("exbin-framework-menu-popup-api"))
    ...
    implementation(exbinFrameworkLibrary("exbin-framework-sidebar"))
    implementation(exbinFrameworkLibrary("exbin-framework-sidebar-api"))
    ...
    implementation(exbinFrameworkLibrary("exbin-framework-options-settings"))
    implementation(exbinFrameworkLibrary("exbin-framework-options-settings-api"))
    ...
    implementation(binedAppLibrary("exbin-framework-bined-operation-code"))
    ...
    implementation(":exbin-framework-language-cs_CZ-0.2.5")
    implementation(":exbin-framework-language-de_DE-0.2.5")
    implementation(":exbin-framework-language-es_ES-0.2.5")
    implementation(":exbin-framework-language-fr_FR-0.2.5")
    implementation(":exbin-framework-language-it_IT-0.2.5")
    implementation(":exbin-framework-language-ja_JP-0.2.5")
    implementation(":exbin-framework-language-ko_KR-0.2.5")
    implementation(":exbin-framework-language-pl_PL-0.2.5")
    implementation(":exbin-framework-language-ru_RU-0.2.5")
    implementation(":exbin-framework-language-zh_Hans-0.2.5")
    implementation(":exbin-framework-language-zh_Hant-0.2.5")
    implementation(":exbin-framework-material-iconset-0.2.5")
