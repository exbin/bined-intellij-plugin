...
//    implementation(jaguifLibrary("jaguif-data"))
    ...
    implementation(jaguifLibrary("jaguif-license"))
    implementation(jaguifLibrary("jaguif-license-api"))
    ...
    implementation(jaguifLibrary("jaguif-tabpages"))
    implementation(jaguifLibrary("jaguif-tabpages-api"))
