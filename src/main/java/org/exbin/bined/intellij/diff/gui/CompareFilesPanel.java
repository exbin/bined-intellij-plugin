...
public class CompareFilesPanel extends javax.swing.JPanel {
    ...
    private final ResourceBundle resourceBundle = App.getModule(LanguageModuleApi.class).getBundle(org.exbin.bined.jaguif.compare.gui.CompareFilesPanel.class);
