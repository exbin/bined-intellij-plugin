...
public class CodeAreaColorOptions implements OptionsData {
    ...
    @Nonnull
    public ExtendedCodeAreaColorProfile getColorProfile(int index) {
    ...
    public void setColorProfile(int index, ExtendedCodeAreaColorProfile colorProfile) {
        ProfileRecord record = profileRecords.get(index);
        record = new ProfileRecord(record.name, colorProfile);
        profileRecords.set(index, record);
    }

    public void removeColorProfile(int index) {
